...
Output sink (device) ID. This is relatively experimental, and will only work in much newer browsers and other contexts like the latest Electron. See [Mozilla Developer Docs](https://developer.mozilla.org/en-US/docs/Web/API/MediaDevices/enumerateDevices) for info.
#### xhr `Object` `null`
